...
urlpatterns = [
    ...
    path('requisitions/status/<int:id>/order/date/<int:order>/', views.RequisitionByStatusViewAndDate.as_view()),
    path('requisitions/status/<int:id>/order/priority/<int:order>/', views.RequisitionByStatusViewAndPriority.as_view()),
